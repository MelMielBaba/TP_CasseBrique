...
/!\ Le depot est paramétré comme privé /!\ Sera passé en publique afin que 
l'enseignant puisse y acceder

►EMPLACEMENT DES LISTE, FILE, PILE◄

►CONTRAINTES DU PROJET◄
-> Le jeu est codé en POO
-> Le jeu doit présenter une implémentation d'une liste, d'une file et d'une pile
